...
if __name__ == "__main__":
    ...
    # Example with your configurations
    models_to_test = [
        {"name": "gemma2:2b", "url": "http://127.0.0.1:11434"},
        {"name": "llama3.2-vision:latest", "url": "http://35.95.163.15:11434"},
    ]
    ...
    for model_config in models_to_test:
        ...
        try:
            ...
            explainer = TokenSHAPWithOllama(
                ...
                config=TokenSHAPConfig(max_samples=10)  # Reduced for demo
            )
